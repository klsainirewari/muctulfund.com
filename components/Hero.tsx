...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden bg-slate-50">
      {/* Background Decor */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-brand-50/50 to-transparent"></div>
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-brand-200 rounded-full blur-3xl opacity-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-white border border-slate-200 shadow-sm text-slate-700 text-sm font-semibold mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex justify-center items-center px-8 py-4 border border-slate-200 text-base font-bold rounded-xl text-slate-700 bg-white hover:bg-slate-50 shadow-sm transition-all hover:border-brand-300"
              >
                Chat on WhatsApp
              </a>
            </div>

            <div className="mt-10 grid grid-cols-2 md:grid-cols-2 gap-x-8 gap-y-4 text-slate-500 max-w-sm mx-auto lg:mx-0">
              <div className="flex items-center">
                <ShieldCheck className="h-5 w-5 mr-3 text-brand-600" />
                <span className="font-medium">AMFI Registered</span>
              </div>
              <div className="flex items-center">
                <BarChart3 className="h-5 w-5 mr-3 text-brand-600" />
                <span className="font-medium">Data-Driven Advice</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 relative w-full max-w-lg lg:max-w-none">
            <div className="relative">
              {/* Main Image */}
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-slate-200 border-8 border-white z-10">
                <img 
                ...
                {/* Floating Card 1 */}
                <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-md p-4 rounded-xl shadow-lg border border-white/50 animate-[bounce_3s_infinite]">
                  <div className="flex items-center gap-3">
                    <div className="bg-green-100 p-2 rounded-lg">
                       <TrendingUp className="h-6 w-6 text-green-600" />
                    </div>
                    <div>
                      <p className="text-xs text-slate-500 font-semibold uppercase">Returns</p>
                ...
                {/* Floating Card 2 */}
                <div className="absolute bottom-6 right-6 bg-white/90 backdrop-blur-md p-4 rounded-xl shadow-lg border border-white/50">
                   <div className="flex items-center gap-3">
                    <div className="bg-brand-100 p-2 rounded-lg">
                       <PieChart className="h-6 w-6 text-brand-600" />
                    </div>
                    <div>
                      <p className="text-xs text-slate-500 font-semibold uppercase">Portfolio</p>
